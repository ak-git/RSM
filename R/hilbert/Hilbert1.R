...
curve(f1, from = from, to = to, n = n, lty = 'dashed', lwd = 2, col = 'blue', font = 2, ylim = ylim, add = TRUE)
...
curve(f2, from = from, to = to, n = n, lty = 'solid', lwd = 2, col = 'orange', font = 2, ylim = ylim)
curve(f3, from = from, to = to, n = n, lty = 'dashed', lwd = 2, col = 'blue', font = 2, ylim = ylim, add = TRUE)
legend("topleft", y.intersp = 2,
